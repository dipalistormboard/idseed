...
class Cool_captcha extends CI_Controller {
     ...
     *
     */
    public $resourcesPath = 'public/cpatcha/resources/';
    ...
    public $session_var = 'wasif_captcha';
    ...
    public function CreateImage() {
		...
		$newdata = array($this->session_var => $text);
