...
class Banner extends CI_Controller 
{
	...
	public function addedit()
	{
		...
		{	
			if($this->modelbanner->getSingleRecord($id)) 
			{
				...
				$uplod_img ="";			
				$getFile=$this->modelbanner->editDetail($id);
			...
			else
			{
				...
				if($this->modelbanner->updateDetais($id,$uplod_img)) // IF UPDATE PROCEDURE EXECUTE SUCCESSFULLY
				{
	...
	public function doedit()
	{
		$data = array();
		$banner_id=$this->uri->segment(4);
		$q = $this->modelbanner->editDetail($banner_id);		
