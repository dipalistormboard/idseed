...
<div class="bodyright">
    <?php if(!empty($details->title)){ if(empty($language)){ ?>
            ...
            <a href="<?php echo site_url("kaizen/glossary/doedit/".$details->id."?language=french"); ?>">
            French
            </a></div>
            ...
            <a href="<?php echo site_url("kaizen/glossary/doedit/".$details->id); ?>">
            English
            </a></div>
								...
								<tr>
										<td align="left" valign="top"><table width="90%" border="0" cellspacing="0" cellpadding="0">
														<tr>
																...
																<td align="left" valign="top" width="349"><input type="text" name="glossary_title" id="glossary_title" value="<?php if(isset($details->title)){echo $details->title;}?>" class="inputinpt validate[required]" /></td>
														</tr>
												</table></td>
								</tr>
								...
								<tr>
										<td align="left" valign="top"><table width="90%" border="0" cellspacing="0" cellpadding="0">
														<tr>
                                                                ...
                                                                <textarea name="glossary_caption" id="glossary_caption"><?php if(isset($details->caption)){echo $details->caption;}?></textarea>
                                                                </td>
														</tr>
												</table></td>
								</tr>
		...
		$remove =  '';
		if($details->picture!='' && is_file(file_upload_absolute_path()."glossary/".$details->picture))	
		{
			
			$image_thumb=file_upload_base_url()."glossary/".$details->picture;
			$remove = "remove";
...
function confirmdel(id){
	if(confirm("Are you sure want to delete image?")){
		window.location.href="<?php echo site_url("kaizen/glossary/dodeleteimg/");?>?deleteid="+id;
	}
	else{
		return false;
	}
