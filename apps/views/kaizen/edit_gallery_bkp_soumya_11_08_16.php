			...
			$image_thumb=file_upload_base_url()."noimage_thumb.jpg";
								...
								<tr class="img">
										<td align="left" valign="top"><table width="483" border="0" cellspacing="0" cellpadding="0">
														<tr>
																<td width="134" align="left" valign="top"><label class="labelname">&nbsp;</label></td>
																<td align="left" valign="top" width="349"><a href="javascript:void(0);" title="Remove" onClick="confirmdel('<?php echo $details->id;?>','gallery_photo');" class="removebtn" >Remove</a></td>
														</tr>
												</table></td>
								</tr>
								<tr class="img">
			...
			$image_thumb=file_upload_base_url()."noimage_thumb.jpg";
								...
								<tr class="gif">
										<td align="left" valign="top"><table width="483" border="0" cellspacing="0" cellpadding="0">
														<tr>
																<td width="134" align="left" valign="top"><label class="labelname">&nbsp;</label></td>
																<td align="left" valign="top" width="349"><a href="javascript:void(0);" title="Remove" onClick="confirmdel('<?php echo $details->id;?>','gif_image');" class="removebtn" >Remove</a></td>
														</tr>
												</table></td>
								</tr>
								<tr class="gif">
...
<a href="javascript:void(0);" title="Delete" onClick="confirmdel_gallery('<?php echo $details->id;?>','<?php echo rawurlencode(site_url("kaizen/gallery/dolist"));?>');" class="darkgreybtn" <?php if(isset($details->id) && $details->id >0){}else{echo 'style="display:none;"';}?>> <span>Delete</span> </a>
&nbsp;&nbsp;&nbsp;&nbsp;
<a href="javascript:void(0);" class="darkgreybtn" onClick="form_submit('edit');"><span>Save</span></a>&nbsp;&nbsp;&nbsp;&nbsp;
 <a href="javascript:void(0);" class="darkgreybtn" onClick="form_submit('<?php echo $pgs.'#'.$details->id; ?>');"><span>Save and Go-Back</span></a>
...
function confirmdel(id,dbfield){
	if(confirm("Are you sure want to delete image?")){
		window.location.href="<?php echo site_url("kaizen/gallery/dodeleteimg/");?>?deleteid="+id+"&dbfield="+dbfield;
	}
	else{
		return false;
	}
