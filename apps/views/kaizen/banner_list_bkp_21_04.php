      ...
      <div class="tabelmiddle">
		...
		else
		{
			$image_thumb = base_url('public/kaizen/images/image-box.gif');
                      ...
                      <td width="89" align="center" valign="middle"><?php echo $row->display_order;?> </td>
                      <td width="65" align="center" valign="middle"><a href="<?php echo site_url("kaizen/banner/doedit/".$row->id);?>" title="Edit" class="edit3"></a></td>
