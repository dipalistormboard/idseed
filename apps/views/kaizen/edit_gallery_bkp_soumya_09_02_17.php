...
<div class="bottonserright" style="padding-bottom:20px;"> 
  ...
  ?>
<a href="javascript:void(0);" title="Delete" onClick="confirmdel_gallery('<?php echo $details->id;?>','<?php echo rawurlencode(site_url("kaizen/gallery/dolist"));?>','<? echo $language?>');" class="darkgreybtn" <?php if(isset($details->id) && $details->id >0){}else{echo 'style="display:none;"';}?>> <span>Delete</span> </a>
&nbsp;&nbsp;&nbsp;&nbsp;
