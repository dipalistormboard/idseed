...
|
*/
/*$config['base_url']	= 'http://www.sfnfci.ca/';
...
$config['base_url']						=   'http://localhost/idseed/';
$config['server_absolute_path'] 		= 	$_SERVER['DOCUMENT_ROOT']."/idseed/"; // site root folder
$config['front_base_url']				= 	$config['base_url'];
$config['file_upload_base_url']			=	$config['front_base_url']."public/uploads/";
$config['file_upload_absolute_path'] 	=	$config['server_absolute_path']."public/uploads/";
...
*/
$config['proxy_ips'] = '';
$config['COMPANY_NAME'] = 'Seed Identification Guide';
$config['SITE_ID'] = '1';
